...
sed -i 's|^sql_alchemy_conn = sqlite:///.*|sql_alchemy_conn = postgresql+psycopg2://grupo-17-rds:yourpassword123@grupo-17-rds.cf4i6e6cwv74.us-east-1.rds.amazonaws.com:5432/grupo-17-rds|' "$AIRFLOW_CFG_PATH"
